...
class SosInsuranceSpider(GenericSpider):
    ...
    def extract_data(item: dict) -> dict:
        ...
        add_value('plan_id', item.get('planId'))
        add_value('end_date', item.get('endDate'))
        add_value('last_name', item.get('lastName'))
        add_value('franchise', item.get('franchize'))
        add_value('first_name', item.get('firstName'))
        add_value('start_date', item.get('startDate'))
        add_value('contract_id', item.get('contractId'))
        add_value('disease_name', item.get('diseaseName'))
        add_value('contract_name', item.get('contractName'))
        add_value('insurance_name', item.get('insuranceName'))
        add_value('remaining_ceiling', item.get('max_coverage'))

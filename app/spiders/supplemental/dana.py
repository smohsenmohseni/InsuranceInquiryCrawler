...
class DanaInsuranceSpider(GenericSpider):
    ...
    def extract_data(data: dict, loader: DanaInsuranceItemLoader) -> None:
        ...
        add_value('id', data.get('Id'))
        add_value('insured', data.get('BSId'))
        add_value('policy_id', data.get('BnID'))
        add_value('gender', data.get('jensText'))
        add_value('first_name', data.get('Name'))
        add_value('end_date', data.get('EndDate'))
        add_value('last_name', data.get('Family'))
        add_value('franchise', data.get('Franshiz'))
        add_value('begin_date', data.get('BeginDate'))
        add_value('birth_year', data.get('BirthYear'))
        add_value('fullname', data.get('BsDisplyName'))
        add_value('remaining_ceiling', data.get('Data'))
        add_value('father_name', data.get('FatherName'))
        add_value('relationship', data.get('NesbatText'))
        add_value('national_code', data.get('CodeMelli'))
        add_value('policy_type_id', data.get('NoeBimenameId'))
        add_value('insured_plan', data.get('TarhBimeshodeId'))
